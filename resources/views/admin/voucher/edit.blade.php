    ...
    <div class="card-body">
        <form action="/admin/voucher/{{ $voucher->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="voucher_code" class="form-control @error('voucher_code') is-invalid @enderror" value="{{ old('voucher_code', $voucher->voucher_code) }}">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" name="is_active" class="form-check-input" id="is_active" {{ $voucher->is_active ? 'checked' : '' }}>
